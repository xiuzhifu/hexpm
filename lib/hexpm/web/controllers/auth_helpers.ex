defmodule Hexpm.Web.AuthHelpers do
  ...
  def organization_access(%Plug.Conn{} = conn, user_or_organization) do
    organization_access(conn.assigns.organization, user_or_organization)
  end

  def organization_access(%Organization{} = organization, %User{} = user) do
    (organization.public or Organizations.access?(organization, user, "read"))
    |> boolean_to_auth_error()
  end

  def organization_access(%Organization{} = organization, %Organization{id: id}) do
    boolean_to_auth_error(organization.id == id)
  end

  def organization_access(%Organization{} = organization, nil) do
    boolean_to_auth_error(organization.public)
  end

  def organization_access(nil, _user_or_organization) do
    {:error, :auth}
  end

  def maybe_organization_access(%Plug.Conn{} = conn, user_or_organization) do
    maybe_organization_access(conn.assigns.organization, user_or_organization)
  end

  def maybe_organization_access(%Organization{} = organization, %User{} = user) do
    (organization.public or Organizations.access?(organization, user, "read"))
    |> boolean_to_auth_error()
  end

  def maybe_organization_access(%Organization{} = organization, %Organization{id: id}) do
    boolean_to_auth_error(organization.id == id)
  end

  def maybe_organization_access(%Organization{} = organization, nil) do
    boolean_to_auth_error(organization.public)
  end

  def maybe_organization_access(nil, _user_or_organization) do
    :ok
  end
