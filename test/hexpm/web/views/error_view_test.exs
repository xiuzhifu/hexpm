defmodule HexpmWeb.ErrorViewTest do
  ...
  test "renders 400.html" do
    assert render_to_string(HexpmWeb.ErrorView, "400.html", conn: conn()) =~
           "Bad request"
  end

  test "renders 404.html" do
    assert render_to_string(HexpmWeb.ErrorView, "404.html", conn: conn()) =~
           "Page not found"
  end

  test "renders 408.html" do
    assert render_to_string(HexpmWeb.ErrorView, "408.html", conn: conn()) =~
           "Request timeout"
  end

  test "renders 413.html" do
    assert render_to_string(HexpmWeb.ErrorView, "413.html", conn: conn()) =~
           "Payload too large"
  end
